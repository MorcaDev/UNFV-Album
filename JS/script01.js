window.addEventListener(`load`, (e) => {
  ...
  let telecomunicaciones_marker = document.getElementById("telecomunicaciones_marker") 
  ...
  let telecomunicaciones_entity = document.getElementById("telecomunicaciones_entity") 
